...
| Срок из подбора переписывает срок в КП, адрес отправителя в переписке, перенаправление письма | `specs/035-wait-term-forward-mail/spec.md` | Implemented |
...
| Модуль 035: срок из подбора в собранном КП, адреса перенаправления, пересылка письма | `php tests/module_035.php` |
