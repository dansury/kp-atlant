...
| Описание товара стоит в поле, печатается в КП и не уходит в письмо | `specs/031-item-description-in-kp/spec.md` | Implemented |
...
| Модуль 031: описание подставлено в поле, печатается одним блоком, в промпт ответа не идёт | `php tests/module_031.php` |
