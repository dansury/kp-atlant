...
| Мастер настройки с нуля, обратная связь в issues и проверочные КП с оценкой качества | `specs/034-setup-wizard-support-trial/spec.md` | Implemented |
...
| Модуль 034: обращения с файлами и ревью, шаги мастера по факту, оценка качества и модель подороже | `php tests/module_034.php` |
