...
| Черновик письма — карточка в «В работе»; контрагент заводится в МойСклад по ИНН из письма | `specs/029-draft-cards-and-moysklad/spec.md` | Implemented |
...
| Модуль 029: черновик первого письма, карточка в «В работе», ИНН из письма в МойСклад | `php tests/module_029.php` |
