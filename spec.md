...
| Вход не выбивает сам себя, но админ видит повторный логин и может его сбросить; звук уведомления свой у каждого; фото в подборе открыты сразу | `specs/043-session-safety-and-sound/spec.md` | Implemented (partial — issue #60) |
...
| Модуль 043: повторный вход уведомляет админов, «Сбросить вход», свой звук уведомлений, фото в подборе открыты сразу | `php tests/module_043.php` |
