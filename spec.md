...
| Письма не налезают друг на друга, ответ несёт цитату, заметка удаляется | `specs/029-letter-layout-quoting-notes/spec.md` | Implemented |
...
| Модуль 029: цитата в ответе, снятие карточки с доски, заметки, удаление письма, вёрстка переписки | `php tests/module_029.php` |
