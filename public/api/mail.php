...
try {
    switch ($action) {
        ...
        case 'thread':
            ...
            // каким ИНН его туда заводить (модуль 029)
            $lastIn = null;
        ...
        case 'send':
            ...
            // даже если форма её не передала (модуль 029)
            $draftKeys = [
            ...
            // на доске и в своей колонке (модуль 029)
        ...
        // ---- Черновик письма: вкладку закрыли — текст остался (модули 023, 029) ----
        ...
        case 'draft_save': {
            ...
            // просто не уходил на сервер (модуль 029)
