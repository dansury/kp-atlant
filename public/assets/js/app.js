...
const App = {
     ...
     * позиции, цены и сроки, а читается товар в КП (модуль 031).
     */
    matchRowExtra(i = {}) {
    ...
    pickSuggest(el, json) {
        ...
        // в поле её описание. Написанное менеджером не трогаем (модуль 031).
