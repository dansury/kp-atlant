...
const App = {
    ...
    async init() {
        ...
        try {
            ...
            // а не на пустую доску (модуль 034). Открытую закладку не трогаем.
    ...
    route() {
        ...
        const open = () => {
            switch (page) {
                case 'mail': {
                    ...
                    // «#mail/new/trial» — проверочный запрос мастера настройки (модуль 034)
        ...
        Promise.resolve().then(open)
            // Карточка проверочного запроса: полоска с оценкой качества (модуль 034)
    ...
    /**
     * Запрос, который пришёл мимо почты (модуль 034).
     *
    ...
    settingsTabs() {
        ...
        return [
            ...
            // Мастер настройки и обратная связь (модуль 034): мастер — админский,
...
// ==== Мастер настройки, обратная связь и проверочное КП (модуль 034) ====
//
