...
final class Boards {
    ...
    public static function sync(?int $boardId = null, bool $force = false): array {
        ...
        // ничего (модуль 029). Возвращает такую карточку новое письмо — ниже.
        //
        ...
        // заводилась вторая, во «Входящих» (модуль 029).
    ...
    /**
     * Карточка уходит С ДОСКИ, а не из базы (модуль 029).
     *
