...
final class Learning {
    ...
    public const KINDS = [
        ...
        // (модуль 040). Это не исправление ошибки, а образец того, как мы
    ...
    /**
     * Отправленное письмо — в пару к письму клиента (модуль 040).
     *
    ...
    /**
     * ==== Переосмыслить правки моделью (модуль 040) ====
     *
