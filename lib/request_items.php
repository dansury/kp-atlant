...
final class RequestItems {
    ...
    public static function all(int $requestId): array {
        ...
        // — в поле сразу его описание, без похода на сервер (модуль 031)
    ...
    public static function toProposalItems(array $rows): array {
        ...
        foreach ($rows as $row) {
            ...
            $out[] = [
                ...
                // возьмёт его сама и напечатает одним блоком (модуль 031).
     ...
     * ожидания.
     *
     * Комментарий по позиции сюда НЕ идёт (модуль 031): это описание товара, и
    ...
    /**
     * Что из комментария принадлежит строке, а что — каталогу (модуль 031).
     *
