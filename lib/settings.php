...
final class Settings {
    ...
    public const SPEC = [
        ...
        'KP_DESCRIPTION_SOURCE' => ['kp', 'Откуда описание товара', 'select:moysklad_first,bitrix_first', false, 'moysklad_first', 'moysklad_first — описание из МойСклад, а если его там нет — с сайта (Битрикс); bitrix_first — наоборот. Описание с сайта приносит модуль atlant.kpsync вместе со ссылками (см. «Сайт (Битрикс)»)'],
