...
PROMPT,
            ...
            'mail_reply' => [
                ...
                'Системный промпт кнопки «Создать ответ» в почте. {{email_rules}} — правила переписки, {{tov}} — тон.',
                ['email_rules', 'tov'],
                <<<'PROMPT'
...
назови следующий шаг. Не выдумывай цены, сроки, остатки и характеристики —
если данных нет, напиши, что уточнишь их и вернёшься с ответом.
