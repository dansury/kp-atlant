...
PROMPT,
            ...
            'find_requisites' => [
                'Поиск реквизитов в письме',
                'Ищет ИНН, КПП, ОГРН и юридическое название компании в переписке и во вложениях, '
                . 'когда обычный поиск по образцу их не нашёл. {{letter}} — текст писем и вложений.',
                ['letter'],
                <<<'PROMPT'
Найди реквизиты КЛИЕНТА (не наши) в переписке ниже.

Что ищем:
- inn: ИНН клиента — 10 цифр у организации, 12 у индивидуального предпринимателя
- kpp: КПП — 9 цифр (только у организации)
- ogrn: ОГРН (13 цифр) или ОГРНИП (15 цифр)
- legal_title: полное юридическое название, как оно написано в документах
- legal_address: юридический адрес

Правила:
1. Берёшь ТОЛЬКО то, что прямо написано в тексте. Ничего не достраиваешь и не угадываешь:
   не нашёл — ставишь null. Выдуманный ИНН хуже отсутствующего.
2. ИНН может стоять без слова «ИНН»: в шапке карточки предприятия, в реквизитах
   под подписью, в скане счёта или договора, в строке «ООО «Ромашка», 7701234567».
3. Реквизиты НАШЕЙ компании — Атлант Армор, ИНН 9731154370 — не берёшь никогда:
   в письме они стоят в цитате нашего же ответа.
4. Если в переписке несколько разных компаний, берёшь ту, от которой письмо пришло.
5. Цифры переписываешь посимвольно, без пробелов и дефисов.

Формат ответа — только JSON, без пояснений:
{"inn": "7701234567" | null, "kpp": "770101001" | null, "ogrn": null,
 "legal_title": "ООО «Ромашка»" | null, "legal_address": null,
 "source": "откуда взял — одной строкой" | null}
